  ...
  <div class="table-box">
    ...
    <div class="card table-main">
      ...
      <el-table ref="myTable" :data="tableData" border size="small">
        ...
        <el-table-column prop="context" label="上下文" align="center" :min-width="220" />
...
import { magicUserLogsList } from '@/api/modules/user.js'
...
const getList = async () => {
  ...
  const res = await magicUserLogsList(params)
  if (res.code === 200) {
