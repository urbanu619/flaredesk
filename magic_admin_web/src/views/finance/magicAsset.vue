  ...
  <div class="table-box">
    ...
    <div class="card table-main">
      ...
      <el-table ref="myTable" :data="tableData" border size="small">
        ...
        <el-table-column prop="balance" label="净资产" align="center" :min-width="150" />
        <el-table-column prop="frozen" label="冻结资产" align="center" :min-width="150" />
        <el-table-column prop="totalAmount" label="总资产" align="center" :min-width="150" />
...
import { magicAssetList } from '@/api/modules/finance.js'
...
const getList = async () => {
  ...
  const res = await magicAssetList(params)
  if (res.code === 200) {
