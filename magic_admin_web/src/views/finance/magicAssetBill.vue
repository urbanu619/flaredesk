  ...
  <div class="table-box">
    ...
    <div class="card table-main">
      ...
      <el-table ref="myTable" :data="tableData" border size="small">
        ...
        <el-table-column prop="beforeBalance" label="变更前余额" align="center" :min-width="150" />
        <el-table-column prop="afterBalance" label="变更后余额" align="center" :min-width="150" />
        <el-table-column prop="billType" label="流水类型" align="center" :min-width="120" />
        ...
        <el-table-column prop="describe" label="描述" align="center" :min-width="220" />
...
import { magicAssetBillList } from '@/api/modules/finance.js'

const timeValue = ref([])
const isShowSearch = ref(true)
const searchForm = ref({ id: null, userId: null, symbol: null })
const tableData = ref([])
...
const getList = async () => {
  ...
  const res = await magicAssetBillList(params)
  if (res.code === 200) {
...
const onResetSearch = () => {
  searchForm.value = { id: null, userId: null, symbol: null }
  timeValue.value = []
  getList()
}
